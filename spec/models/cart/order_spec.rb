    ...
    describe 'public methods' do
      describe '#shipping_address' do
        context 'when not using :billing_address' do
          it 'returns :shipping_address' do
            ...
            shipping_address = build_stubbed(:cart_shipping_address)
        ...
        context 'when using :billing_address' do
          it 'returns :billing_address' do
            ...
            billing_address = build_stubbed(:cart_billing_address)
      ...
      describe '#subtotal' do
        it 'sums line_items subtotals' do
          line_item1 = create :cart_line_item, price: 10, quantity: 1
          line_item2 = create :cart_line_item, price: 20, quantity: 3
