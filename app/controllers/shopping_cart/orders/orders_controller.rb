...
module ShoppingCart
  class Orders::OrdersController < ApplicationController
    ...
    load_and_authorize_resource class: 'ShoppingCart::Order', through: :current_user, except: :create
    ...
    private
      ...
      def ensure_cart_isnt_empty
        redirect_to(main_app_products_url, notice: t('cart_is_empty')) unless @cart.line_items.exists?
      end
